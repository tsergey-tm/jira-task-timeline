...
export function transformDataToSeriesMultiCheckbox(field: JiraFieldInfo, category: string[], maxTime: number, createdTime: number): SeriesOption[] {
    ...
    return checkboxData.map(checkbox => {
        ...
        return {
            ...
            name: field.name,
            data: data,
            renderItem: renderMultiCheckbox,
            encode: {
